...
$sql = "UPDATE Visites SET visites = visites+1 WHERE id = 1";
$conn->query($sql);

$sql = "SELECT visites FROM Visites WHERE id = 1";
...
<head>
    ...
    <title><?php echo $nom ?> - Digital & Tech Company</title>
    ...
    <link rel="shortcut icon" href="./template/assets/images/fav.png" />
...
<body>
    <div id="header">
        <div class="menu-style-two menu-style-four menu-style-six">
            <div class="header-menu style-two">
                <div class="container"> <a class="logo" href="">
                        <svg width="148" height="36" viewbox="0 0 148 36" fill="none"
                            ...
                            <g clip-path="url(#clip0_7015_1124)">
                            ...
                            <path
                                ...
                                fill="#0C1228"></path>
                            <defs>
                                <clippath id="clip0_7015_1124">
                                    <rect width="26" height="36" fill="black"></rect>
                                </clippath>
                            </defs>
                        </svg></a>
                    <div class="menu-main">
                        <ul class="flex-center">
                                            ...
                                            <div class="row">
                                                <div class="col-9">
                                                    <div class="item">
                                                        ...
                                                        <div class="list-service mt-8">
                                                            <div class="row">
                                                                <div class="col-4"><a
                                                                        class="nav-item-main service-item flex-item-center"
                                                                        href="service-detail.html" data-item="solution1"
                                                                        data-cate="IT Solutions">
                                                                        <div class="icon"> <i
                                                                                class="icon-phone-sync fs-28"></i></div>
                                                                        <div class="service-name text-button pl-8">
                                                                            Managed IT Services</div>
                                                                    </a></div>
                                                                <div class="col-4"><a
                                                                        class="nav-item-main service-item flex-item-center"
                                                                        href="service-detail.html" data-item="solution2"
                                                                        data-cate="IT Solutions">
                                                                        <div class="icon"> <i
                                                                                class="icon-user-sync fs-28"></i></div>
                                                                        <div class="service-name text-button pl-8">IT
                                                                            Consulting</div>
                                                                    </a></div>
                                                                <div class="col-4"><a
                                                                        class="nav-item-main service-item flex-item-center"
                                                                        href="service-detail.html" data-item="solution3"
                                                                        data-cate="IT Solutions">
                                                                        <div class="icon"> <i
                                                                                class="icon-device-cloud fs-28"></i>
                                                                        </div>
                                                                        <div class="service-name text-button pl-8">Cloud
                                                                            Computing</div>
                                                                    </a></div>
                                                                <div class="col-4"><a
                                                                        class="nav-item-main service-item flex-item-center"
                                                                        href="service-detail.html" data-item="solution4"
                                                                        data-cate="IT Solutions">
                                                                        <div class="icon"> <i
                                                                                class="icon-cloud-dots fs-28"></i></div>
                                                                        <div class="service-name text-button pl-8">
                                                                            Cybersecurity Solutions</div>
                                                                    </a></div>
                                                                <div class="col-4"><a
                                                                        class="nav-item-main service-item flex-item-center"
                                                                        href="service-detail.html" data-item="solution5"
                                                                        data-cate="IT Solutions">
                                                                        <div class="icon"> <i
                                                                                class="icon-phone-cloud fs-28"></i>
                                                                        </div>
                                                                        <div class="service-name text-button pl-8">Data
                                                                            Analytics</div>
                                                                    </a></div>
                                                                <div class="col-4"><a
                                                                        class="nav-item-main service-item flex-item-center"
                                                                        href="service-detail.html" data-item="solution6"
                                                                        data-cate="IT Solutions">
                                                                        <div class="icon"> <i
                                                                                class="icon-device-sync fs-28"></i>
                                                                        </div>
                                                                        <div class="service-name text-button pl-8">
                                                    ...
                                                    <div class="item mt-20">
                                                        ...
                                                        <div class="list-service mt-8">
                                                            <div class="row">
                                                                <div class="col-4"><a
                                                                        class="nav-item-main service-item flex-item-center"
                                                                        href="service-detail.html" data-item="solution7"
                                                                        data-cate="Business Consulting">
                                                                        <div class="icon"> <i
                                                                                class="icon-coin-user fs-28"></i></div>
                                                                        <div class="service-name text-button pl-8">
                                                                            Business Strategy Analysis</div>
                                                                    </a></div>
                                                                <div class="col-4"><a
                                                                        class="nav-item-main service-item flex-item-center"
                                                                        href="service-detail.html" data-item="solution8"
                                                                        data-cate="Business Consulting">
                                                                        <div class="icon"> <i
                                                                                class="icon-user-time fs-28"></i></div>
                                                                        <div class="service-name text-button pl-8">
                                                                            Project Management</div>
                                                                    </a></div>
                                                                <div class="col-4"><a
                                                                        class="nav-item-main service-item flex-item-center"
                                                                        href="service-detail.html" data-item="solution9"
                                                                        data-cate="Business Consulting">
                                                                        <div class="icon"> <i
                                                                                class="icon-hand-up fs-28"></i></div>
                                                                        <div class="service-name text-button pl-8">
                                                                            Operational Optimization</div>
                                                                    </a></div>
                                                                <div class="col-4"><a
                                                                        class="nav-item-main service-item flex-item-center"
                                                                ...
                                                                <div class="col-4"><a
                                                                        ...
                                                                        data-cate="Business Consulting">
                                                                        <div class="icon"> <i
                                                                                class="icon-target-chart fs-28"></i>
                                                                        </div>
                                                                        <div class="service-name text-button pl-8">
                                                                ...
                                                                <div class="col-4"><a
                                                                        ...
                                                                        data-cate="Business Consulting">
                                                                        <div class="icon"> <i
                                                                                class="icon-user-chart fs-28"></i></div>
                                                                        <div class="service-name text-button pl-8">
                                                ...
                                                <div class="col-3">
                                                    <div class="content bg-linear bora-8 p-24">
                                                        ...
                                                        <div class="caption1 text-on-surface-variant1 mt-4">Unlocking
                                                            the Full Spectrum of IT Solutions and Business Consulting
                                                            for your needs</div>
                                                        <div class="block-button mt-20"> <a
                                                                class="button bg-purple button-purple-hover text-white border-none text-button-small"
                                                                href="service-detail.html">Explore Now </a></div>
                                                        <div class="more-infor mt-32">
                                                            <div class="mail flex-item-center"><i
                                                                    class="ph ph-envelope fs-18"> </i>
                                                                <div class="caption1 pl-8"><?php echo $mail ?></div>
                                                            </div>
                                                            <div class="call flex-item-center mt-16"> <i
                                                                    class="ph-fill ph-phone fs-14 p-4 bg-purple text-white bora-50"></i>
                                                                <div class="text-title pl-8">+216 <?php echo $tel1 ?>
                                                                </div>
                                                            </div>
                                                            <div class="list-social flex-item-center gap-10 mt-28"><a
                                                                    class="item bora-50 w-40 h-40 flex-center border-on-surface"
                                                                    href="<?php echo $facebook ?>" target="_blank"><i
                                                                        class="icon-facebook"></i></a><a
                                                                    class="item bora-50 w-40 h-40 flex-center border-on-surface"
                                                                    href="<?php echo $linkedin ?>" target="_blank"><i
                                                                        class="icon-linkedin"></i></a><a
                                                                    class="item bora-50 w-40 h-40 flex-center border-on-surface"
                                                                    href="<?php echo $twitter ?>" target="_blank"><i
                                                                        class="icon-twitter"></i></a><a
                                                                    class="item bora-50 w-40 h-40 flex-center border-on-surface"
                                                                    href="<?php echo $youtube ?>" target="_blank"><i
                                                                        class="icon-youtube"></i></a><a
                                                                    class="item bora-50 w-40 h-40 flex-center border-on-surface"
                                                                    href="<?php echo $instagram ?>" target="_blank"><i
                                                                        class="icon-instagram fs-14"></i></a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <li> <a href="#!">Company</a>
                                <ul class="sub-nav">
                                    <li class="sub-nav-item"><a class="sub-nav-link" href="about-us.html">About Us</a>
                                    </li>
                                    <li class="sub-nav-item"> <a class="sub-nav-link" href="pricing-plan.html">Pricing
                                            Plan</a></li>
                                    <li class="sub-nav-item"> <a class="sub-nav-link" href="our-team.html">Our Teams</a>
                                    </li>
                                    <li class="sub-nav-item"> <a class="sub-nav-link" href="team-detail.html">Team
                                            Details</a></li>
                                    <li class="sub-nav-item"> <a class="sub-nav-link"
                                            href="list-testimonials.html">Testimonials</a></li>
                                </ul>
                            </li>
                            <li class="sub-nav-item"><a class="sub-nav-link" href="about-us.php">About Us</a></li>

                        </ul>
                    </div>
                    <div class="right-block flex-item-center">
                        <div class="menu-humburger"><i class="ph ph-list"></i></div><a
                            class="button bg-purple button-purple-hover text-white border-none text-button-small ml-40"
                    ...
                    <div class="menu-mobile-main">
                        <div class="container">
                            <div class="heading flex-between"><a class="logo-mobile" href="">
                                    <svg width="148" height="36" viewbox="0 0 148 36" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_7015_188)">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                d="M15.5918 15.4774L13.0001 12.9447L10.4083 15.4774C8.98899 16.8643 8.98899 19.1357 10.4083 20.5427L13.0001 23.0754L15.5918 20.5427C17.0111 19.1357 17.0111 16.8643 15.5918 15.4774ZM12.9795 0L3.80544 8.96482C1.27538 11.4372 6.10352e-05 14.7136 6.10352e-05 17.9698C6.10352e-05 21.2261 1.27538 24.5025 3.80544 26.9749L6.39721 29.5075L11.8687 24.1608L9.27696 21.6281C8.24848 20.6231 7.73424 19.2965 7.73424 17.9698C7.73424 16.6432 8.24848 15.3166 9.27696 14.3116L18.4716 5.34673L12.9795 0ZM13.0001 36L22.1741 27.0352C24.7247 24.5427 26.0001 21.2663 26.0001 18.01C26.0001 14.7538 24.7247 11.4774 22.1947 9.00502L19.6029 6.47236L14.1314 11.8191L16.7232 14.3518C17.7516 15.3568 18.2659 16.6834 18.2659 18.01C18.2659 19.3367 17.7516 20.6633 16.7232 21.6683L7.54911 30.6332L13.0001 36Z"
                                                fill="#0C1228"></path>
                                        </g>
                            ...
                            <ul class="menu-nav-mobile">
                                <li class="nav-item-mobile flex-column gap-8 pt-8 pb-8 pl-12 pr-12 pointer"><a
                                        class="nav-link-mobile" href="index.php">Home </i></a>

                                </li>
                                <li class="nav-item-mobile flex-column gap-8 pt-4 pb-8 pl-12 pr-12 pointer"><a
                                        class="nav-link-mobile" href="#!">Solutions <i
                                    ...
                                    <div class="sub-nav-mobile">
                                        <div class="row flex-between gap-16 flex-wrap">
                                            <div class="item">
                                                ...
                                                <div class="list-service d-flex flex-column gap-16 mt-16"> <a
                                                        class="nav-item-main service-item flex-item-center"
                                                        href="service-detail.html" data-item="solution1"
                                                        data-cate="IT Solutions">
                                                        <div class="icon"> <i class="icon-phone-sync fs-28 d-block"></i>
                                                        </div>
                                                        <div class="text-button pl-12">Managed IT Services</div>
                                                    </a><a class="nav-item-main service-item flex-item-center"
                                                        href="service-detail.html" data-item="solution2"
                                                        data-cate="IT Solutions">
                                                        <div class="icon"> <i class="icon-user-sync fs-28"></i></div>
                                                        <div class="text-button pl-12">IT Consulting</div>
                                                    </a><a class="nav-item-main service-item flex-item-center"
                                                        href="service-detail.html" data-item="solution3"
                                                        data-cate="IT Solutions">
                                                        <div class="icon"> <i
                                                                class="icon-device-cloud fs-28 d-block"></i></div>
                                                        <div class="text-button pl-12">Cloud Computing</div>
                                                    </a><a class="nav-item-main service-item flex-item-center"
                                                        href="service-detail.html" data-item="solution4"
                                                        data-cate="IT Solutions">
                                                        <div class="icon"> <i class="icon-cloud-dots fs-28 d-block"></i>
                                                        </div>
                                                        <div class="text-button pl-12">Cybersecurity Solutions</div>
                                                    </a><a class="nav-item-main service-item flex-item-center"
                                                        href="service-detail.html" data-item="solution5"
                                                        data-cate="IT Solutions">
                                                        <div class="icon"> <i
                                                                class="icon-phone-cloud fs-28 d-block"></i></div>
                                                        <div class="text-button pl-12">Data Analytics</div>
                                                    </a><a class="nav-item-main service-item flex-item-center"
                                                        href="service-detail.html" data-item="solution6"
                                                        data-cate="IT Solutions">
                                                        <div class="icon"> <i
                                                                class="icon-device-sync fs-28 d-block"></i></div>
                                                        <div class="text-button pl-12">Software Development</div>
                                                    </a></div>
                                            </div>

                                            <div class="content bg-linear bora-8 p-24">
                                                <div class="heading6">Explore All Services</div>
                                                <div class="fs-14 text-on-surface-variant1 mt-4">Unlocking the Full
                                                    Spectrum of IT Solutions and Business Consulting for your needs
                                                </div>
                                                <div class="block-button mt-20"> <a
                                                        class="button bg-purple button-purple-hover text-white border-none text-button-small"
                                                        href="service-detail.html">Explore Now </a></div>
                                                <div class="more-infor mt-20">
                                                    <div class="mail flex-item-center"><i class="ph ph-envelope fs-18">
                                                        </i>
                                                        <div class="fs-14 pl-8"><?php echo $mail ?></div>
                                                    </div>
                                                    <div class="call flex-item-center mt-12"> <i
                                                            class="ph-fill ph-phone fs-14 p-4 bg-purple text-white bora-50"></i>
                                                        <div class="text-title pl-8">+216 <?php echo $tel1 ?></div>
                                                    </div>
                                                    <div class="list-social flex-item-center gap-10 mt-28"><a
                                                            class="item bora-50 w-40 h-40 flex-center border-on-surface"
                                                            href="<?php echo $facebook ?>" target="_blank"><i
                                ...
                                <li class="nav-item-mobile flex-column gap-8 pt-4 pb-8 pl-12 pr-12 pointer"><a
                                        class="nav-link-mobile" href="#!">Company <i
                                            class="ph ph-caret-right fs-12"></i></a>
                                    <ul class="sub-nav-mobile">
                                        <li class="sub-nav-item pl-12 pr-12 pt-8 pb-8 active"><a class="sub-nav-link"
                                                href="about-us.html">About Us</a></li>
                                        <li class="sub-nav-item pl-12 pr-12 pt-8 pb-8"> <a class="sub-nav-link"
                                                href="pricing-plan.html">Pricing Plan</a></li>
                                        <li class="sub-nav-item pl-12 pr-12 pt-8 pb-8"> <a class="sub-nav-link"
                                                href="our-team.html">Our Team</a></li>
                                        <li class="sub-nav-item pl-12 pr-12 pt-8 pb-8"> <a class="sub-nav-link"
                                                href="team-detail.html">Team Detail</a></li>
                                        <li class="sub-nav-item pl-12 pr-12 pt-8 pb-8"> <a class="sub-nav-link"
                                                href="list-testimonials.html">Testimonials</a></li>
                                    </ul>
                                </li>
