<div id="footer">
      <div class="footer-style-three footer-style-four footer-style-six">
        <div class="footer-block style-four bg-black-surface pt-60">
          <div class="container">
            <div class="row row-gap-32">
              <div class="col-xl-3 col-md-6">
                <div class="footer-company-infor d-flex flex-column gap-20"><a class="logo" href="index.html">
                    <svg width="148" height="36" viewbox="0 0 148 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_7015_1198)">
              ...
              <div class="col-12 col-md-6">
                <div class="footer-navigate">
                  ...
                  <div class="footer-nav-item">
                    ...
                    <ul class="list-nav mt-12">
                      <li class="mt-8"><a class="caption1 text-line hover-underline" href="service-detail.html">Financial Advisory</a></li>
                      <li class="mt-8"><a class="caption1 text-line hover-underline" href="service-detail.html">Investment Management</a></li>
                      <li class="mt-8"><a class="caption1 text-line hover-underline" href="service-detail.html">Retirement Planning</a></li>
                      <li class="mt-8"><a class="caption1 text-line hover-underline" href="service-detail.html">Risk Management & Insurance</a></li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-md-6 col-12">
                <div class="list-infor">
                  ...
                  <div class="flex-item-center mt-20"><i class="ph ph-envelope fs-20"></i>
                    <div class="body2 pl-8"><?php echo $adresse ?></div>
                  </div>
                  <div class="flex-item-center mt-20"><i class="ph ph-phone-call fs-20"></i>
                    <div class="body2 pl-8">+216 <?php echo $tel1 ?></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="bg-black-surface">
            <div class="container bg-black-surface">
              <div class="footer-bottom flex-between pt-8 pb-8">
                <div class="left-block flex-item-center gap-16">
                  <div class="copy-right text-on-surface-variant2 caption1">©2024 <span class="text-white"><?php echo $nom ?></span></div><a class="text-on-surface-variant2 caption1 hover-underline" href="#!">Terms Of Services</a><a class="text-on-surface-variant2 caption1 hover-underline" href="#!">Privacy Policy</a>
                </div>
                <div class="list-social flex-item-center gap-10 mt-28"><a class="item bora-50 w-40 h-40 flex-center border-on-surface" href="<?php echo $facebook ?>" target="_blank"><i class="icon-facebook"></i></a><a class="item bora-50 w-40 h-40 flex-center border-on-surface" href="<?php echo $linkedin ?>" target="_blank"><i class="icon-linkedin"></i></a><a class="item bora-50 w-40 h-40 flex-center border-on-surface" href="<?php echo $twitter ?>" target="_blank"><i class="icon-twitter"></i></a><a class="item bora-50 w-40 h-40 flex-center border-on-surface" href="<?php echo $youtube ?>" target="_blank"><i class="icon-youtube"></i></a><a class="item bora-50 w-40 h-40 flex-center border-on-surface" href="<?php echo $instagram ?>" target="_blank"><i class="icon-instagram fs-14"></i></a></div>
              </div>
            </div>
          </div>
        </div>
